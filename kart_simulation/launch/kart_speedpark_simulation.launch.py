...
def generate_launch_description():
    ...
    track_description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [FindPackageShare("race_tracks"), "/launch", "/speedpark.launch.py"]
        ),
    )
    ...
    navigation_launch = IncludeLaunchDescription(
        ...
        launch_arguments={"track": "speedpark"}.items()
    )
    ...
    kart_spawn = Node(
        ...
        name="spawn_kart",
        arguments=["-entity", "kart"+"_01", "-topic", "robot_description"+"_01", "-x", "24.831161", "-y", "21.493725", "-z", "0.4", "-Y", "-0.884128"],
        output="screen",
    )
    ...
    return LaunchDescription(
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={"world": os.path.join(FindPackageShare("race_tracks").find("race_tracks"), "worlds", "speedpark_track.world"), "pause":"true"}.items()
        ),
        ...
        Node(
            ...
            executable="spawn_entity.py",
            name="spawn_track",
            arguments=["-entity", "speedpark", "-topic", "track_description", "-x", "0", "-y", "0", "-z", "-0.713456"],
            output="screen",
        ),
